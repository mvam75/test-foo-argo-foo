---
permalink: /1.11/cilium/v2/ciliumExternalWorkload/
---

# cilium.v2.ciliumExternalWorkload
...
* [`obj spec`](#obj-spec)
  * [`fn withIpv4-Alloc-Cidr(ipv4_alloc_cidr)`](#fn-specwithipv4-alloc-cidr)
  * [`fn withIpv6-Alloc-Cidr(ipv6_alloc_cidr)`](#fn-specwithipv6-alloc-cidr)
...
new returns an instance of CiliumExternalWorkload
...
### fn spec.withIpv4-Alloc-Cidr

```ts
withIpv4-Alloc-Cidr(ipv4_alloc_cidr)
```
...
### fn spec.withIpv6-Alloc-Cidr

```ts
withIpv6-Alloc-Cidr(ipv6_alloc_cidr)
```
