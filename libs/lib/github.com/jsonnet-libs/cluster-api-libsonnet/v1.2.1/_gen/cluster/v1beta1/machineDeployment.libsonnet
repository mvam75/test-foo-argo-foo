  ...
  spec: {
    ...
    template: {
      ...
      spec: {
        ...
        '#withNodeDeletionTimeout':: d.fn(help='"NodeDeletionTimeout defines how long the controller will attempt to delete the Node that the Machine hosts after the Machine is marked for deletion. A duration of 0 will retry deletion indefinitely. Defaults to 10 seconds."', args=[d.arg(name='nodeDeletionTimeout', type=d.T.string)]),
