---
permalink: /v1.2.1/cluster/v1beta1/cluster/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.topology`](#obj-spectopology)
    ...
    * [`fn withVariables(variables)`](#fn-spectopologywithvariables)
    * [`fn withVariablesMixin(variables)`](#fn-spectopologywithvariablesmixin)
    * [`fn withVersion(version)`](#fn-spectopologywithversion)
    * [`obj spec.topology.controlPlane`](#obj-spectopologycontrolplane)
      * [`fn withNodeDrainTimeout(nodeDrainTimeout)`](#fn-spectopologycontrolplanewithnodedraintimeout)
    ...
    * [`obj spec.topology.variables`](#obj-spectopologyvariables)
      * [`fn withName(name)`](#fn-spectopologyvariableswithname)
      * [`fn withValue(value)`](#fn-spectopologyvariableswithvalue)
    * [`obj spec.topology.workers`](#obj-spectopologyworkers)
      ...
      * [`obj spec.topology.workers.machineDeployments`](#obj-spectopologyworkersmachinedeployments)
        ...
        * [`fn withFailureDomain(failureDomain)`](#fn-spectopologyworkersmachinedeploymentswithfailuredomain)
        * [`fn withName(name)`](#fn-spectopologyworkersmachinedeploymentswithname)
        * [`fn withNodeDrainTimeout(nodeDrainTimeout)`](#fn-spectopologyworkersmachinedeploymentswithnodedraintimeout)
        ...
        * [`obj spec.topology.workers.machineDeployments.variables`](#obj-spectopologyworkersmachinedeploymentsvariables)
          * [`fn withOverrides(overrides)`](#fn-spectopologyworkersmachinedeploymentsvariableswithoverrides)
          * [`fn withOverridesMixin(overrides)`](#fn-spectopologyworkersmachinedeploymentsvariableswithoverridesmixin)
          * [`obj spec.topology.workers.machineDeployments.variables.overrides`](#obj-spectopologyworkersmachinedeploymentsvariablesoverrides)
            * [`fn withName(name)`](#fn-spectopologyworkersmachinedeploymentsvariablesoverrideswithname)
            * [`fn withValue(value)`](#fn-spectopologyworkersmachinedeploymentsvariablesoverrideswithvalue)
...
### fn spec.topology.withVariables
...
### fn spec.topology.withVariablesMixin
...
### fn spec.topology.controlPlane.withNodeDrainTimeout
...
## obj spec.topology.variables

"Variables can be used to customize the Cluster through patches. They must comply to the corresponding VariableClasses defined in the ClusterClass."

### fn spec.topology.variables.withName
...
### fn spec.topology.variables.withValue
...
### fn spec.topology.workers.machineDeployments.withFailureDomain
...
### fn spec.topology.workers.machineDeployments.withNodeDrainTimeout
...
## obj spec.topology.workers.machineDeployments.variables

"Variables can be used to customize the MachineDeployment through patches."

### fn spec.topology.workers.machineDeployments.variables.withOverrides
...
### fn spec.topology.workers.machineDeployments.variables.withOverridesMixin
...
## obj spec.topology.workers.machineDeployments.variables.overrides

"Overrides can be used to override Cluster level variables."

### fn spec.topology.workers.machineDeployments.variables.overrides.withName
...
### fn spec.topology.workers.machineDeployments.variables.overrides.withValue
