---
permalink: /1.11/cilium/v2/ciliumIdentity/
---
...
* [`fn new(name)`](#fn-new)
* [`fn withSecurity-Labels(security_labels)`](#fn-withsecurity-labels)
* [`fn withSecurity-LabelsMixin(security_labels)`](#fn-withsecurity-labelsmixin)
...
new returns an instance of CiliumIdentity

### fn withSecurity-Labels

```ts
withSecurity-Labels(security_labels)
```

"SecurityLabels is the source-of-truth set of labels for this identity."

### fn withSecurity-LabelsMixin

```ts
withSecurity-LabelsMixin(security_labels)
```
