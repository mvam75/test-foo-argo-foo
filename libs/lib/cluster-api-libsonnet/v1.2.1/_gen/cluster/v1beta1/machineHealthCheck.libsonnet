{
  ...
  '#spec':: d.obj(help='"Specification of machine health check policy"'),
  spec: {
    ...
    '#selector':: d.obj(help='"Label selector to match machines whose health will be exercised"'),
    selector: {
    ...
    '#withNodeStartupTimeout':: d.fn(help='"Machines older than this duration without a node will be considered to have failed and will be remediated. If not set, this value is defaulted to 10 minutes. If you wish to disable this feature, set the value explicitly to 0."', args=[d.arg(name='nodeStartupTimeout', type=d.T.string)]),
