{
  ...
  spec: {
    ...
    topology: {
      ...
      '#variables':: d.obj(help='"Variables can be used to customize the Cluster through patches. They must comply to the corresponding VariableClasses defined in the ClusterClass."'),
      variables: {
        '#withName':: d.fn(help='"Name of the variable."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"Value of the variable. Note: the value will be validated against the schema of the corresponding ClusterClassVariable from the ClusterClass. Note: We have to use apiextensionsv1.JSON instead of a custom JSON type, because controller-tools has a hard-coded schema for apiextensionsv1.JSON which cannot be produced by another type via controller-tools, i.e. it is not possible to have no type field. Ref: https://github.com/kubernetes-sigs/controller-tools/blob/d0e03a142d0ecdd5491593e941ee1d6b5d91dba6/pkg/crd/known_types.go#L106-L111"', args=[d.arg(name='value', type=d.T.any)]),
      ...
      '#withVariables':: d.fn(help='"Variables can be used to customize the Cluster through patches. They must comply to the corresponding VariableClasses defined in the ClusterClass."', args=[d.arg(name='variables', type=d.T.array)]),
      withVariables(variables): { spec+: { topology+: { variables: if std.isArray(v=variables) then variables else [variables] } } },
      '#withVariablesMixin':: d.fn(help='"Variables can be used to customize the Cluster through patches. They must comply to the corresponding VariableClasses defined in the ClusterClass."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='variables', type=d.T.array)]),
      ...
      workers: {
        ...
        machineDeployments: {
          ...
          '#withFailureDomain':: d.fn(help='"FailureDomain is the failure domain the machines will be created in. Must match a key in the FailureDomains map stored on the cluster object."', args=[d.arg(name='failureDomain', type=d.T.string)]),
