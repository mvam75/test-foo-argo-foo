{
  ...
  spec: {
    ...
    strategy: {
      ...
      '#withType':: d.fn(help='"Type of deployment. Currently the only supported strategy is \\"RollingUpdate\\". Default is RollingUpdate."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    template: {
      ...
      metadata: {
        '#ownerReferences':: d.obj(help='"List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. \\n Deprecated: This field has no function and is going to be removed in a next release."'),
        ownerReferences: {
      ...
      spec: {
        ...
        bootstrap: {
          '#configRef':: d.obj(help='"ConfigRef is a reference to a bootstrap provider-specific resource that holds configuration details. The reference is optional to allow users/operators to specify Bootstrap.Data without the need of a controller."'),
          configRef: {
            '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
          ...
          '#withData':: d.fn(help='"Data contains the bootstrap data, such as cloud-init details scripts. If nil, the Machine should remain in the Pending state. \\n Deprecated: Switch to DataSecretName."', args=[d.arg(name='data', type=d.T.string)]),
