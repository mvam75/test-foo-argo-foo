{
  ...
  spec: {
    ...
    '#withNodeStartupTimeout':: d.fn(help='"Machines older than this duration without a node will be considered to have failed and will be remediated."', args=[d.arg(name='nodeStartupTimeout', type=d.T.string)]),
